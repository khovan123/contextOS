...
import { parseSkillMetadata } from "../plugins/ctx/lib/skill-discoverer.js";

const repoRoot = path.resolve(import.meta.dirname, "..");
const communitySkillsDir = path.join(repoRoot, "community-skills");
const expectedSeeds = ["eas", "jwt-auth", "oauth-google", "prisma", "redis", "vercel"];
