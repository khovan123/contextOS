...
export function createScoreService({
  scoreContext,
  dataDir,
  concurrency = Number(process.env.CONTEXTOS_SCORE_CONCURRENCY || 1),
  cacheTtlMs = Number(process.env.CONTEXTOS_SCORE_CACHE_TTL_MS || 60_000),
  requestTimeoutMs = Number(process.env.CONTEXTOS_SCORE_REQUEST_TIMEOUT_MS || 2_500),
