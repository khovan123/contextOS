...
import { createScoreService } from "../lib/scoring-service.js";
...
const sectionTimeoutMs = Number(process.env.CONTEXTOS_SECTION_TIMEOUT_MS || 800);
...
const server = createContextOSMcpServer({ dataDir, getHealth: bridgeHealth, scoreContextRunner: scoreService.score });
